...
- **`plugins/lampainit-invc.js`** добавляет в основное меню Lampa пункт **«Дорамы»** сразу после **«Сериалы»**.
- Пункт открывает `category_full` с прямым TMDB Discover TV фильтром `with_original_language=ko`, `with_genres=18`, потому что CUB-источник не применяет языковой фильтр для корейских дорам.
